<template>
  ...
  <vue-custom-scrollbar class="scroll-area" :settings="settings" @ps-scroll-y="scrollHandle">
    <div ref="root" class="tableRow flexRowCenter tableRowHeader" @mousedown="handleScroll">
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const namespaceWrapper = ref(props.namespaceWrapper)
    ...
    const scrollToRight = (): void => {
      ...
      const maxWidth = root.value.querySelector('.rowValue').scrollWidth;
    ...
    const scrollHorizontal = () => {
      const content = root.value.querySelector('.tableValue');
    ...
    const init = () => {
      ...
      itemWidth.value = root.value.querySelector('.tableValueItem').scrollWidth;
