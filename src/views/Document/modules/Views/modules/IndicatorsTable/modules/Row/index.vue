<template>
  <div
    ref="root"
    class="tableRow flexRowCenter tableContent"
  ...
  >
    ...
    <div class="rowIndex flexRowCenterTable tableValue tableRowName" style="max-width: 220px">
        <div class="check_icon__wrapper">
          <img v-if="getItem.visible && !isReportPage" alt="!!!" :src="changingIcon" class="check_icon" />
        </div>
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const scrollToRight = (): void => {
      const maxWidth = root.value.querySelector('.rowValue.flexRowCenter.tableValue').scrollWidth;
