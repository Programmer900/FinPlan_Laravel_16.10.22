<template>
  <div v-if="isInit" class="tableIndicators __custom">
    <div class="greyBg">
      <div class="flexWrapperColumn wrapperUtils">
        ...
        <div class="table">
          ...
          <div class="tableProps flexRowBetween">
            <DocumentIndicatorsTableProps @onChangeParam="onChangeParam" @onChangeDocumentTableReport="onChangeDocumentTableReport"/>
            <DocumentIndicatorsTableUtils @changeSwitch="showMiddleProfit" :isUtils="isShowUtils" />
          </div>
...
import DocumentIndicatorsTableAlert from '@/views/Document/modules/Views/modules/IndicatorsTableCustom/modules/Alert/index.vue';
import DocumentIndicatorsTableProps from '@/views/Document/modules/Views/modules/IndicatorsTableCustom/modules/Props/index.vue';
import DocumentIndicatorsTableUtils from '@/views/Document/modules/Views/modules/IndicatorsTableCustom/modules/Utils/index.vue';
import DocumentIndicatorsTableRow from '@/views/Document/modules/Views/modules/IndicatorsTableCustom/modules/Row/index.vue';
import DocumentIndicatorsTableHeader from '@/views/Document/modules/Views/modules/IndicatorsTableCustom/modules/Header/index.vue';
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const type = ref<string>('year')

    const onChangeParam = (paramName: string) => {
      emit('onChangeParam', paramName);
    };

    const onChangeDocumentTableReport = (paramName: string) => {
      type.value = paramName
    };
    ...
    return {
      onChangeParam, onChangeDocumentTableReport, type,
