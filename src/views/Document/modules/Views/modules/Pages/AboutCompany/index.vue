  ...
  <div class="greyBg">
    <div class="flexWrapperRow">
      <div
        ...
        v-html="previewText.replace(/#IMG#/g, '').replace(/<a\b[^>]*>/i,'').replace(/<\/a>/i, '')"
      />
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      return {
        //previewText: store.getters['documentStore/getEmitentData'].PREVIEW_TEXT.replace(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._\+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_\+.~#?&//=]*)/gi,""),
