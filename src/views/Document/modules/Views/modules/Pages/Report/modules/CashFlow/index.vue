...
<script lang="ts">
  ...
  import DocumentIndicatorsTable from '@/views/Document/modules/Views/modules/IndicatorsTableReportCashFlow/index.vue';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const getIndicators = computed(() => store.getters['documentStore/getIndicatorsReportCashFlowChart']);
...
<style scoped lang="scss">
  .__cash-flow .flexWrapperColumn:hover {
